$(function() {
	...
	var firstpic = $(".picmidmid ul li").first().find("images");
	...
	function nextclick() {
		...
		if (currrentindex != (length - 1)) {
			...
			var curnextsrc = curnextli.find("images").attr("bigimg");
			var curnexttxt = curnextli.find("images").attr("text");
			curli.find("images").removeClass("selectpic");
			curnextli.find("images").addClass("selectpic");
	...
	getli.click(function() {
		...
		$(".picmidmid ul li images[class='selectpic']").removeClass("selectpic");
		var currentli = getli.eq(currentliindex);
		currentli.find("images").addClass("selectpic");
		var bigimgsrc = currentli.find("images").attr("bigimg");
		var curnexttxt = currentli.find("images").attr("text");
	...
	$(".replaybtn2").click(function() {
		$(".endtop").css("display", "none");
		$(".bodymodal").css("display", "none");
		$(".detail_picbot_mid ul li images[class='selectpic']").removeClass("selectpic");
		$(".detail_picbot_mid ul li").eq(0).find("images").addClass("selectpic");
		var bigimgsrc = $(".detail_picbot_mid ul li").eq(0).find("images").attr("bigimg");
		$("#pic1").attr("src", bigimgsrc);
	...
	$(".ranknext").click(function() {
		...
		if (show < length) {
			...
			$(this).attr("show", show);
			$(".rank ul").eq(show).find("images").lazyload()
		} else {
			$(".rank ul").css("display", "none");
			$(".rank ul").first().css("display", "block");
			$(this).attr("show", 0);
			$(".rank ul").first().find("images").lazyload()
		}
	});
